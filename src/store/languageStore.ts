 ...
 * Supports: English (en), German (de), Spanish (es), Mandarin (zh)
 */
import { create } from 'zustand';

export type Language = 'en' | 'de' | 'es' | 'zh';
...
const translations = {
  en: {
    ...
    // Appearance / Settings
    language: 'Language', theme: 'Theme', textSize: 'Text Size',
  ...
  de: {
    store: 'Shop', library: 'Bibliothek', pen: 'Stift', profile: 'Profil',
    signIn: 'Anmelden', signUp: 'Registrieren', createAccount: 'Konto erstellen',
    email: 'E-Mail', password: 'Passwort', firstName: 'Vorname', lastName: 'Nachname',
    childName: 'Kindername', childNameOptional: 'Kindername (optional)',
    childNameHint: 'Der Name Ihres Kindes in der App',
    forgotPassword: 'Passwort vergessen?', continueWithGoogle: 'Mit Google fortfahren',
    rememberMe: 'Angemeldet bleiben', noAccount: 'Noch kein Konto?',
    hasAccount: 'Bereits ein Konto?',
    orDivider: 'oder',
    myLibrary: 'Meine Bibliothek', noBooks: 'Noch keine Bücher',
    noBooksHint: 'Stöbere im Shop und lade Bücher herunter',
    removingBook: 'Buch entfernen',
    removeConfirm: 'Möchten Sie dieses Buch wirklich aus Ihrer Bibliothek entfernen?',
    remove: 'Entfernen', cancel: 'Abbrechen',
    account: 'Konto', preferences: 'Einstellungen', support: 'Support',
    signOut: 'Abmelden', editProfile: 'Profil bearbeiten', changePassword: 'Passwort ändern',
    updateInfo: 'Informationen aktualisieren', updatePassword: 'Passwort aktualisieren',
    notifications: 'Benachrichtigungen', manageNotif: 'Benachrichtigungen verwalten',
    appearance: 'Darstellung', appearanceDesc: 'Hell, dunkel oder auto',
    parentalControls: 'Kindersicherung', parentalDesc: 'Familieneinstellungen',
    helpSupport: 'Hilfe & Support', termsPrivacy: 'AGB & Datenschutz', about: 'Über uns',
    language: 'Sprache', theme: 'Design', textSize: 'Textgröße',
    light: 'Hell', dark: 'Dunkel', auto: 'Auto',
    lightDesc: 'Klassisches helles Design', darkDesc: 'Augenschonend bei Nacht', autoDesc: 'Folgt Geräteeinstellung',
    small: 'Klein', medium: 'Mittel', large: 'Groß',
    saveChanges: 'Änderungen speichern', appearanceSaved: '✓ Darstellung gespeichert!',
    preview: 'Vorschau',
    download: 'Herunterladen', downloaded: 'Heruntergeladen ✓', back: '← Zurück',
  ...
  es: {
    ...
    language: 'Idioma', theme: 'Tema', textSize: 'Tamaño de texto',
  ...
  zh: {
    ...
    language: '语言', theme: '主题', textSize: '文字大小',
