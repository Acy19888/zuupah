...
const translations = {
  en: {
    ...
    // Appearance / Settings
    language: 'Language', languageDesc: 'English, Deutsch, Español, 中文', theme: 'Theme', textSize: 'Text Size',
  ...
  de: {
    ...
    language: 'Sprache', languageDesc: 'Sprache der App wählen', theme: 'Design', textSize: 'Textgröße',
