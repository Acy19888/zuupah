...
const styles = StyleSheet.create({
  ...
  backButton: { width: 60 },
  backText: { fontSize: TYPOGRAPHY.fontSize.base, fontWeight: '600' as const, color: COLORS.beachBlue },
  libraryBadge: {
    backgroundColor: COLORS.softPillowBlue, paddingHorizontal: 10,
    paddingVertical: 4, borderRadius: 12,
  },
  libraryBadgeText: { fontSize: TYPOGRAPHY.fontSize.xs, color: COLORS.beachBlue, fontWeight: '600' as const },
  ...
  badgeText: { fontSize: TYPOGRAPHY.fontSize.xs, fontWeight: '600' as const, color: COLORS.darkText },
  category: { fontSize: TYPOGRAPHY.fontSize.sm, color: COLORS.lightText },
  rating: { fontSize: TYPOGRAPHY.fontSize.base, fontWeight: '600' as const, color: COLORS.darkText },
  ...
  detailValue: { fontSize: TYPOGRAPHY.fontSize.sm, fontWeight: '600' as const, color: COLORS.darkText },
  footer: {
  ...
  price: { fontSize: TYPOGRAPHY.fontSize.lg, fontWeight: '700' as const, color: COLORS.zestyOrange },
  downloadButton: { flex: 1 },
  // Library / Rating UI
  ratingSection: { flex: 1, alignItems: 'center', gap: 8 },
  ratedTitle: { fontSize: TYPOGRAPHY.fontSize.base, fontWeight: '700' as const, color: COLORS.darkText },
  ...
  markUsedText: { color: COLORS.beachBlue, fontWeight: '600' as const, fontSize: TYPOGRAPHY.fontSize.sm },
