...
const styles = StyleSheet.create({
  ...
  backButton: {
    ...
    fontWeight: '600' as const, marginBottom: 16,
  },
  title: {
    fontSize: TYPOGRAPHY.fontSize['3xl'], fontWeight: '700' as const,
  ...
  showButtonText: { fontSize: TYPOGRAPHY.fontSize.sm, color: COLORS.beachBlue, fontWeight: '600' as const },
  ...
  checkboxTick: { color: COLORS.white, fontSize: 13, fontWeight: '700' as const, lineHeight: 16 },
  ...
  errorText: { color: COLORS.white, fontSize: TYPOGRAPHY.fontSize.sm, fontWeight: '500' as const },
  ...
  footerLink: { fontSize: TYPOGRAPHY.fontSize.sm, color: COLORS.beachBlue, fontWeight: '700' as const },
});
